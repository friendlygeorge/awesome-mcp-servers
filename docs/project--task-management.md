...
- [friendlygeorge/cron-scheduler-mcp-server](https://github.com/friendlygeorge/cron-scheduler-mcp-server): 7 tools for AI agent cron job scheduling with SQLite persistence, retry logic, and structured observability. MIT license, systemd integration, webhook triggers. Install: `npx @supernova123/cron-scheduler-mcp-server`. Transport: stdio. Auth: none.