...
- [PSPDFKit/nutrient-dws-mcp-server](https://github.com/PSPDFKit/nutrient-dws-mcp-server): Nutrient Document Web Services MCP server for PDF and Office document workflows including conversion, merge, redaction, signing, OCR, watermarking, and extraction.
...
- [pictify-io/mcp](https://github.com/pictify-io/mcp): Render images, animated GIFs, and PDFs from HTML/CSS, live URLs, or reusable Handlebars/FabricJS templates. Batch up to 100 personalised renders per request and A/B test image variants with built-in experiments. Hosted remote at `https://mcp.pictify.io` or self-host via `npx -y @pictify/mcp-server`.
- [demo112/mcp-server-convert](https://github.com/demo112/mcp-server-convert): Converts PDF, DOCX, HTML, EPUB, CSV, Excel, PowerPoint, JSON, XML to Markdown via MCP tools with batch processing and metadata extraction.
...
- [alichherawalla/video-overlay-kit](https://github.com/alichherawalla/video-overlay-kit): Render 4-6s animated b-roll overlay videos for short-form social (LinkedIn, IG Reels, YouTube Shorts, TikTok) and landscape video. MCP-driven: paste a script, the AI writes the scene spec and renders the mp4. Free, MIT, runs locally.
